...
const MellPlusNiger = () => {
  ...
  const slides = [
    ...
    {
      id: 2,
      title: "Dernières technologies Apple",
      subtitle: "iPhone 15, MacBook Pro, iPad Pro",
      description: "Découvrez la nouvelle gamme Apple avec des offres exclusives et un service après-vente premium",
      image: "/api/placeholder/600/400",
    ...
    {
      id: 3,
      title: "Solutions climatisation",
      subtitle: "Climatiseurs Samsung & LG",
  ...
  const partners = [
    ...
    { name: 'Intel', logo: '/api/placeholder/120/60' },
    { name: 'Lenovo', logo: '/api/placeholder/120/60' },
